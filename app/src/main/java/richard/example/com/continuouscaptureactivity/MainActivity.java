...
import richard.example.com.continuouscaptureactivity.gles.EglCore;
import richard.example.com.continuouscaptureactivity.gles.FullFrameRect;
import richard.example.com.continuouscaptureactivity.gles.Texture2dProgram;
import richard.example.com.continuouscaptureactivity.gles.WindowSurface;
    ...
    implements SurfaceHolder.Callback, SurfaceTexture.OnFrameAvailableListener
{
    ...
    private SurfaceTexture mCameraTexture; //receive the output from the camera preview
    ...
    private static class MainHandler extends Handler
            implements CircularEncoder.Callback
    {
    ...
    // opens a camera, and attemps to establish preview mode at the specified width and height
